    ...
    ui(new Ui::UserWnd)
{
    ...
    ui->userView->setColumnWidth(0, 41.25);
    ui->userView->setColumnWidth(1, 123.75);
    ui->userView->setColumnWidth(2, 165);
    ui->userView->setColumnWidth(3, 165);
    ui->userView->setColumnWidth(4, 330);
